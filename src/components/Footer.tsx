  ...
  useEffect(() => {
    const loadUserPreferences = async (): Promise<void> => {
      try {
        ...
        const policy = socialMediaPolicies[userData.country_name] || socialMediaPolicies.default;
            ...
            <div className="flex space-x-4">
              {showAllIcons && (
                <a
                  ...
                  className="text-gray-600 hover:text-blue-400 duration-200 cursor-pointer"
                  aria-label="GitHub"
                >
                  <svg
                    className="w-6 h-6"
